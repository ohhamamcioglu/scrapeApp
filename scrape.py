            ...
            for product in products:
                ...
                for variant in variants:
                    variant_data = {
                        ...
                        # 'body_html': body_html, # omit to keep CSV cleaner, can enable if needed
                        'vendor': vendor,
...
if __name__ == "__main__":
    base_url = "https://boutiquerugs.co.uk"
    df = scrape_shopify_products(base_url)
    
    output_file = "boutiquerugs_products.csv"
